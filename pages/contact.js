            ...
            <div className={`${styles.bottom} container`} >
                ...
                <section className="section">
                    ...
                    <div id="links" className={styles.links}>
                        ...
                        <span className="-gray"> Download my </span> <a id={styles.btn} target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1WpxIYWI9ghv1l3wPkw9YfWqGc-JyQ0NP/view?usp=sharing"> resume
